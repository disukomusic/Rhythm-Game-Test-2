...
public class NoteSpawner : MonoBehaviour
{
    ...
    public void SpawnNote(int lane, NoteType ntype, int noteStartTime, int holdNoteEndTime)
    {
        ...
        if (note != null)
        {
            ...
            desiredNote.isHoldNote = ntype == NoteType.Hold;
            ...
            //Debug.Log("spawned note at lane " + lane + " of type " + ntype + " with start time " + noteStartTime +
